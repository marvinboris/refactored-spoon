...
class Index extends Component {
    ...
    render() {
        ...
        const content = (
            <>
                <Row>
                    <List array={data} loading={loading} data={JSON.stringify(products)} get={this.props.get} total={total} bordered add={add} link="/user/products/add" icon={faProductHunt} title={index} className="shadow-sm"
                        fields={[
                            { name, key: 'name' },
